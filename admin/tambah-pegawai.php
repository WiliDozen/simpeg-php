...
// keyika tombol tambah ditekan, jalankan script dibawah ini..
    ...
    <main>
        <div class="container-fluid">
            ...
            <ol class="breadcrumb mb-4">
                <!-- dibuat agar waktu aktif didaftar Pegawai ade tulisan dashboard kalo diklik nimbul dashboard -->
                    ...
                    <input type="hidden" name="id_user" value="">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" name="email" id="email" class="form-control" required minlength="8">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6">
                                ...
                                <input type="date" name="tmk" id="tmk" class="form-control" required
                                    minlength="6">
                            </div>
                            <div class="form-group col-sm-6">
                            <label for="foto"><b>Gambar <small>(Max 2 MB)</small></b></label><br>
                        ...
                        <div class="float-right">
                            <button type="submit" name="tambah" class="btn btn-primary"><i class="fas fa-plus">
                                </i> Tambah </button>
                        </div>
                    </form>
                </div>
